      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="text-2xl font-bold text-cyan-400 italic">Next Level</h1>
          </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-800">
            {navItems.map((item) => (
              <a
                ...
                className={cn(
                  ...
                  item.active ? "text-cyan-400 bg-gray-700" : "text-gray-300 hover:text-cyan-400 hover:bg-gray-700",
                )}
            ...
            <div className="pt-4 pb-3 border-t border-gray-700">
              <div className="flex flex-col space-y-3 px-3">
                ...
                <Button className="bg-cyan-400 text-gray-900 hover:bg-cyan-500 w-full">Become a Creator</Button>
              </div>
            </div>
          </div>
        </div>
