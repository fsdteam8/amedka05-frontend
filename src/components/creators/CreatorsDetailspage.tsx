      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="w-full space-y-6">
            ...
            {singleTalent.socialMedia && singleTalent.socialMedia.length > 0 && (
              <div className="space-y-3">
                <h2 className="text-2xl font-bold text-white italic">
                  Social Media
                </h2>
            ...
            {/* Contact Section */}
            <div className="space-y-3">
              <h2 className="text-2xl font-bold text-white italic">Contact</h2>
              <div className="space-y-3">
...
<div className="mt-16 bg-gray-800/30 rounded-2xl p-8 border border-gray-700/30">
  ...
  <p className="text-gray-300 text-base leading-relaxed">
    {singleTalent.description
      ? singleTalent.description
      : `${singleTalent.fullName} is a prominent lifestyle and fashion influencer with a keen eye for the latest trends and a talent for turning inspiration into style. She collaborates with notable brands across the fashion and lifestyle industry, creating engaging content that resonates with her audience. Through her extensive career experiences, personal travel adventures, and fashion-forward Instagram presence, ${singleTalent.fullName.split(" ")[0]} shares a unique perspective that blends authenticity with creativity. Her work not only showcases the latest trends but also inspires her followers to embrace their individuality and express themselves confidently.`}
  </p>
</div>
